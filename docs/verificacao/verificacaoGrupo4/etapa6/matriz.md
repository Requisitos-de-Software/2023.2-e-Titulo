# Verificação da matriz do Grupo 4
...
### Inspeção com o checklist e vídeo da Verificação da matriz
...
**Tabela 1** - Checklist para a inspeção dos Itens da matriz.
...
| MTZ1 | No artefato há uma tabela com ID, Descrição,	Artefatos relacionados (Origem), Pré-Rastreabilidade,	Implementado e os ELOS ?| Incompleto | observação abaixo |
| MTZ2 | Os indentificadores possuem likagem de rastreabilidade?  | Sim ||
...
- MTZ3 - A tecnica terá de ser corrigida juntamente com as demais , pois há registro de requisitos funcionais elicitados como não funcionais. Erros vindo das tecnicas de elicitação.
- MTZ1 - Seria interessante adicionar na tabela ou onde for nescessário uma parte respônssavél por conter os ELOS.
