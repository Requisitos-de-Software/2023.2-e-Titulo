# Verificação do cronograma do Grupo 4
...
| ---| -------- | --------- | ------------ |
| G1  | O artefato possui Introdução? | Sim | Nos dois artefatos (cronograma planejado e executado) possuem introdução |
| G2  | O artefato possui Objetivo? | Sim | Nos dois artefatos (cronograma planejado e executado) possuem objetivo |
| G4  | O artefato contém bibliográfia/referência seguindo as normas da ABNT? | Sim | -- |
| G5  | O artefato possui o histórico de versões contendo a Versão, Data, Descrição, Autor(es) e Revisor(es)? | Sim | -- |
| G6  | As imagens/Figuras/vídeos/tabelas estão na norma ABNT no artefato, com legendas e fontes? (isso no caso do artefato possuir tais elementos) | Não | Nos dois artefatos (cronograma planejado e executado) Não seguem a ABNT nas tabelas |
...
| G8  | As bibliográfias/referências estão padronizados sendo chamados com a norma ABNT nos textos do artefato?  | Incompleto | estão padronizados, mas não são chamados no texto |
...
| CM5 | O cronograma de planejamento e de executado possuem em cada tabela as seguintes informações: **O nome da atividade, Data do início e Data do Fim da atividade, a Data da Revisão, o Autor(es) e Revisor(es), e o local da realização da atividade**? (exeto na tabela geral) | Incompleto | Nos dois artefatos (cronograma planejado e executado) faltam informar o local da realização da atividade |
...
| CM9 | No cronograma executado possue todas as atividades esperadas no cronograma de planejamento? | Incompleto  | na Entrega 5.1 o de planejamento não possui os artefatos especificado no cronograma executado |
...
O artefato do cronograma está legal, mas pode melhorar, logo abaixo são minhas sugestões de melhorias:

- Colocar as tabelas presentes nos dois artefatos o de cronograma planejado e executado nas normas ABNT.
- Seria legal chamar as bibliográfias no texto dos dois artefatos.
- Falta detalhar mais nos dois artefatos, um exemplo é sobre a criação do miro presente no Brainstorming, não explica no cronograma quem fez e nem revisores muito menos período da criação deste documento. No cronograma de planejamento na entrega 5.2, detalha melhor sobre quais artefatos vão ser criados, pois está muito geral. 
- É interessante colocar textos explicando sobre as tabelas no artefato do cronograma planejado.
- Nos dois artefatos faltam informar o local da realização da atividade nas tabelas.
...
| `1.2`  | 24/11/2023 | Adicionando as sugestões. | [Maria Barbosa](https://github.com/Madu01) |  [Mariiana Siqueira](https://github.com/Maryyscreuza) |
