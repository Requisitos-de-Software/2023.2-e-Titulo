...
Este artefato verifica o artefato de priorização realizado pelo grupo 5 apresentando a inspeção do [Three Level Scale](https://requisitos-de-software.github.io/2023.2-Jitsi/Elicitacao/priorizacao/TLS/) indicando sugestões e melhorias se necessário. 
...
### Inspeção do artefato do Three Level Scale

**Tabela 1** - Inspeção do Three Level Scale.
