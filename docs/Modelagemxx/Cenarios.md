...
| **Contexto**    | Ambiente e monento onde acontece o Cenário |
...
## Cenários
A seguir, as tabelas de 2 a 11 representarão os cenários referentes aos requisitos funcionais do aplicatico e-título priozizados pela técnica [Three Level-Scale](https://requisitos-de-software.github.io/2023.2-e-Titulo/elicitacao/priorizacao/threeLevelScale/)
...
| **Contexto**    | O aplicativo móvel e-Título foi criado pelo TSE com o objetivo de simplificar o acesso aos serviços eleitorais, oferecendo aos cidadãos uma maneira conveniente de gerenciar o seu status eleitoral. |
| **Atores**      | 1. Usuário: - O cidadão que deseja utilizar os serviços do e-Título. <br /> 2. Sistema e-Título: - O aplicativo desenvolvido pelo TSE.|
...
| **Episódios**   | 1. Abertura do Aplicativo: - O usuário realiza o download do aplicativo e-Título na loja de aplicativos do seu dispositivo. <br /> - Ao abrir o aplicativo, é apresentada a tela inicial de boas-vindas. <br /> 2. Início do Cadastro: - O usuário seleciona a opção "Realizar Cadastro" na tela inicial. <br /> - O sistema solicita informações pessoais, incluindo nome completo, número do CPF e data de nascimento. <br /> 3. Validação de Dados: - O aplicativo realiza a verificação dos dados fornecidos, garantindo a autenticidade das informações. <br /> 4. Criação de Senha: - O usuário escolhe uma senha segura para proteger o acesso ao e-Título. <br /> 5. Conclusão do Cadastro: - Após a confirmação, o sistema exibe uma mensagem de sucesso e direciona o usuário para a tela de login. <br /> 6. Acesso ao e-Título: - O usuário realiza o login utilizando seu CPF ou N° de título, e a senha cadastrada.|
| **Exceção**     | Caso o usuário encontre dificuldades durante o processo de cadastro, o aplicativo oferece suporte online e instruções para solucionar problemas. |
...
| **Objetivo**    | Permitir que os eleitores acessem o e-Título de forma segura e eficiente, utilizando autenticação por senha ou biometria. |
| **Contexto**    | O e-Título é um aplicativo desenvolvido pelo Tribunal Superior Eleitoral (TSE) para oferecer serviços eleitorais aos cidadãos brasileiros. O acesso ao aplicativo requer autenticação para garantir a segurança e a integridade dos dados eleitorais.|
| **Atores**      | 1. Usuário: Eleitor que já se cadastrou no aplicativo e-Título. <br /> 2. Sistema e-Título: Plataforma que gerencia as informações eleitorais e oferece serviços ao usuário. |
...
| **Exceção**     | Em caso de falha na autenticação, o sistema notifica o usuário e fornece instruções para recuperar acesso à conta, como redefinição de senha. |
...
| **Objetivo**    | Possibilitar aos eleitores a obtenção da via digital do título de eleitor de forma rápida e conveniente por meio do aplicativo e-Título. |
| **Contexto**    | No contexto do processo eleitoral, é crucial proporcionar aos cidadãos uma alternativa digital para acessar seu título de eleitor, simplificando o processo e promovendo amobilidade. |
| **Atores**      | 1. Eleitor: Indivíduo que possui título de eleitor e deseja obter a via digital <br /> 2. Sistema e-Título: Aplicativo desenvolvido pelo Tribunal Superior Eleitoral (TSE) para serviços eleitorais. |
...
| **Exceção**     | Em caso de falha na autenticação ou verificação de dados, o sistema exibirá uma mensagem de erro, orientando o eleitor a revisar as informações ou contatar o suporte técnico. |
...
| **Contexto**    | O Tribunal Superior Eleitoral (TSE) desenvolveu o aplicativo e-Título para oferecer aos eleitores uma via digital do título eleitoral e outros serviços eleitorais por meio de dispositivos móveis. |
| **Atores**      | 1. Eleitor: Indivíduo que possui título de eleitor e deseja obter a via digital. <br /> 2. Sistema e-Título: Aplicativo desenvolvido pelo Tribunal Superior Eleitoral (TSE) para serviços eleitorais.|
...
| **Exceção**     | Em caso de recusa dos termos de uso, o usuário é direcionado para encerrar o aplicativo. |
...
| **Contexto**    | No ambiente do aplicativo e-Título, é essencial fornecer aos usuários uma maneira eficaz de recuperar o acesso em caso de esquecimento de senha. |
| **Atores**      | 1. Eleitor: Indivíduo que possui título de eleitor e deseja obter a via digital. <br/> 2. Sistema e-Título: Aplicativo desenvolvido pelo Tribunal Superior Eleitoral (TSE) para serviços eleitorais. |
...
| **Exceção**     | Se a identidade do usuário não puder ser verificada com sucesso, o processo de recuperação é bloqueado, e o usuário é orientado a entrar em contato com o suporte. |
...
| **Contexto**    | Para cumprir as regulamentações eleitorais e garantir a segurança do processo, o aplicativo e-Título deve ser acessado apenas por usuários que atendam ao requisito mínimo de idade para votação. |
| **Atores**      | 1. Eleitor: Indivíduo que possui título de eleitor e deseja obter a via digital. <br /> 2. Sistema e-Título: Aplicativo desenvolvido pelo Tribunal Superior Eleitoral (TSE) para serviços eleitorais. |
...
| **Exceção**     | Em caso de identificação de dados falsos ou suspeitos, o sistema pode bloquear o acesso e solicitar verificações adicionais |
...
| **Contexto**    | Para garantir a integridade e confiabilidade dos documentos eleitorais no aplicativo e-Título, os usuários devem ter a capacidade de verificar a autenticidade de seus documentos de maneira fácil e segura. |
| **Atores**      | 1. Eleitor: Indivíduo que possui título de eleitor e deseja obter a via digital. <br/> 2. Sistema e-Título: Aplicativo desenvolvido pelo Tribunal Superior Eleitoral (TSE) para serviços eleitorais. |
...
| **Exceção**     | Se a verificação identificar qualquer irregularidade no documento, o usuário é notificado e orientado a entrar em contato com o suporte técnico. |
...
| **Contexto**    | Para promover a participação democrática, é essencial manter os eleitores informados sobre os horários de votação durante as eleições. |
| **Atores**      | 1. Eleitor: Indivíduo que possui título de eleitor e deseja obter a via digital. <br/> 2. Sistema e-Título: Aplicativo desenvolvido pelo Tribunal Superior Eleitoral (TSE) para serviços eleitorais. |
...
| **Exceção**     | Em caso de mudanças de última hora nos horários de votação devido a circunstâncias excepcionais, uma notificação urgente é enviada aos usuários. |
...
| **Contexto**    | A proteção de dados é crucial para garantir a confiança dos usuários e cumprir as regulamentações de privacidade. |
| **Atores**      | 1. Eleitor: Indivíduo que possui título de eleitor e deseja obter a via digital. <br/> 2. Sistema e-Título: Aplicativo desenvolvido pelo Tribunal Superior Eleitoral (TSE) para serviços eleitorais. |
...
| **Exceção**     | Em caso de detecção de atividade suspeita ou violação de segurança, são acionados procedimentos de resposta a incidentes para proteger os dados e os usuários. |
...
| **Contexto**    | Um design intuitivo contribui para a facilidade de uso do aplicativo, garantindo que os usuários possam navegar e acessar as funcionalidades de maneira eficiente. |
| **Atores**      | 1. Eleitor: Indivíduo que possui título de eleitor e deseja obter a via digital. 2. Sistema e-Título: Aplicativo desenvolvido pelo Tribunal Superior Eleitoral (TSE) para serviços eleitorais. |
...
| **Exceção**     | Em casos de melhorias significativas no design que possam afetar a usabilidade, os usuários recebem notificações e orientações claras sobre as mudanças. |
